...
//       try {
//         const token = localStorage.getItem('token');
//         const userCountResponse = await axios.get('http://localhost:5000/auth/count', {
//           headers: { Authorization: `Bearer ${token}` },
//         });
//         const taskCountResponse = await axios.get('http://localhost:5000/tasks/count', {
//           headers: { Authorization: `Bearer ${token}` },
//         });
...
//               <div className="profile-name-container">
//                 <h2 className="profile-name">Admin</h2>
//                 <FontAwesomeIcon icon={faAngleDown} className="dropdown-icon" onClick={toggleContextMenu} />
//               </div>
//             </div>
//             {showContextMenu && (
//               <div className="context-menu active">
...
//         </div>
//         <div className="summary-section">
//           <Link to="/admin/user-management" className="summary-card">
//             <div className="summary-card-content">
//               <FontAwesomeIcon icon={faUsers} className="icon" />
//               <div className="card-content">
//                 <h3 className="summary-title">Users</h3>
