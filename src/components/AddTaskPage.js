...
//             const assigneesArray = assignees && typeof assignees === 'string' ? assignees.split(',').map(assignee => assignee.trim()) : [];
            
//             // Prepare comments array
//             const commentsArray = comments && typeof comments === 'string' ? comments.split(',').map(comment => ({ content: comment.trim() })) : [];
